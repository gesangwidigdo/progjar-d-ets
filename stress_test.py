...
class StressTestClient:
    def __init__(self, server_address=('172.16.16.101', 42331)):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--host', default='172.16.16.101', help='Server host (default: localhost)')
    parser.add_argument('--port', type=int, default=42331, help='Server port (default: 42331)')
